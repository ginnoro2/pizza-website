...
if(isset($_POST['add_to_cart'])){
   ...
   if($user_id == ''){
      ...
      if($select_cart->rowCount() > 0){
         ...
         echo $insert_cart->execute([$user_id, $pid, $name, $price, $qty, $image]);
...
if(isset($_POST['order'])){
   ...
   if($user_id == ''){
      ...
      $query = "INSERT INTO orders(id, user_id, name, numbers, method, address, total_products, total_price) VALUES(NULL,'$user_id', '$name','$number','$method','$address','$total_products','$total_price')";
      $conn->query($query);
...
<head>
   ...
   <title>Emilios Pizza and Wine</title>
...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>P</span>izza and wine.</a>

      <nav class="navbar">
         <a href="#home">Emilio</a>
...
<div class="my-orders">
   ...
   <section>
      ...
      <div class="box">
         ...
         <p> number : <span><?= $fetch_orders['numbers']; ?></span> </p>
   ...
   <section class="home" id="home">
      ...
      <div class="slide-container">
         ...
         <div class="slide active">
            ...
            <div class="content">
               <h3>Ndjua and Pepperoni Pizza</h3>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>A pizzeria founded only to specialize with Napoletian pizzas, selected italian wines and french press.</p>
      ...
      <div class="box">
         ...
         <p>A quality pizza paired with a fine glass of wine in an outdoor garden and mild tone of jazz sound.</p>
      </div>

      <div class="box">
         <img src="images/l.JPG" alt="">
         <h3>Sharing is Caring</h3>
         <p>You may want to tell someone about good stuff and take fortune home to cheerup with your friends.</p>
      </div>
   ...
   <?php
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" name="numbers" class="box" required placeholder="enter your number" min="0" max="9999999999" onkeypress="if(this.value.length == 10) return false;">
         </div>
         <div class="inputBox">
      ...
      <input type="submit" class="btn" name="order"  value="order now">
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3> Mail me</h3>
         <p>Code - 230</p>
         <p>ginnoro@@gmail.com</p>
      </div>

   </div>

   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>aliment.Cf</span> | all rights reserved!
   </div>
